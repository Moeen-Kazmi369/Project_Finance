...
const RLBox2 = () => {
    ...
    series: [
      {
        name: 'People',
        data: [
          1000, 2300, 3000, 1500, 2000, 4000, 2000, 1800, 2500, 3000, 3200,
          2500, 1700,
        ],
      },
    ],
  ...
  return (
    <div className="rounded-2xl h-full p-4 border border-[#eae9e9] shadow-lg  flex flex-col">
      ...
      <div className="grid grid-cols-4 gap-4 mb-4">
        <div className="p-4 bg-gray-100 col-span-4 sm:col-span-1 rounded-lg text-center">
